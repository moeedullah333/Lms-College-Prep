        ...
        <div class="container-fluid">
            ...
            <div class="row ">
                ...
                <div class="col-md-10 mx-auto d-flex justify-content-end ">
                    <a href="{{ route('admin.admin.add.page') }}" class="btn btn-primary btn-sm">Add Admin</a>
                </div>
            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="table_action_btns_main">
                                                        <button
                                                            onclick="window.location.href='{{ route('admin.admin.update.page', $admin->id) }}'"
                                                            class="table_action_btn"><i
                                                                class="fa-solid fa-pen-to-square"></i></button>
                                                        <button
                                                            onclick="window.location.href='{{ route('admin.delete.admin', $admin->id) }}' "
                                                            class="table_action_btn"><i
