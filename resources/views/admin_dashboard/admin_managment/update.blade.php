        ...
        <div class="row">
            <div class="col-md-10 mx-auto">
                <div class="student_form_main">
                    <form action="{{route('admin.add.update.admin',$user->id)}}" method="POST">
                        @csrf
                        <div class="form-row mb-3">
                            <div class="col">
                                <label for="firstname">First Name</label>
                                <input type="text" id="firstname" class="form-control" placeholder="First name" value="{{$user->first_name}}" name="first_name">
                            </div>
                            <div class="col">
                                <label for="lastname">Last Name</label>
                                <input type="text" id="lastname" class="form-control" placeholder="Last name" value="{{$user->last_name}}" name="last_name">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                                placeholder="Please Enter Email" value="{{$user->email}}" name="email"> 
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">Password</label>
                            <input type="password" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                                placeholder="Please Enter Password" value="{{$user->password}}" name="password"> 
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">Confirm Password</label>
                            <input type="password" class="form-control" id="c_password" aria-describedby="emailHelp"
                                placeholder="Please Enter Confirm Password" name="" value="{{$user->password}}" name="c_password"> 
                        </div>
