                ...
                <div class="page_top_bar">
                    <div class="heading_with_icons">
                        <div class="sidebar_humburger_icon">
                            ...
                            <h2 class="main_page_heading">Add Course</h2>
                        </div>
        ...
        <div class="row">
            <div class="col-md-10 mx-auto">
                <div class="student_form_main">
                    <form id="form1" action="{{ route('admin.course.add.update') }}" class="needs-validation" novalidate
                        ...
                        <div class="form-row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="instructor_name" class="form-control"
                                    placeholder="Enter Instructor Name" name="instructor_name" required>
                            </div>
                        </div>
                        <div class="form-row ">
                            <div class="form-group col-md-3">
                                <label for="file">Upload Image</label>
                                <input type="file" required class="form-control" onchange="previewImage(this)" id="file"
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="number" id="total_hour" class="form-control" placeholder="Enter Total Hour"
                        ...
                        <div class="form-row ">
                            <div class="form-group col-md-4">
                                ...
                                <select class="form-control" required id="day" name="day">
                                    <option value="">Select</option>
                                    @foreach ($day as $val)
                                        <option {{ old('day') == $val ? 'selected' : '' }} value="{{ $val }}">
                                            {{ $val }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="time" class="form-control" value="{{ old('time1') }}" required
                                    id="time1" name="time1">
                                @error('time1')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="time" class="form-control" value="{{ old('time2') }}" required
                                    id="time2" name="time2">
                                @error('time2')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
