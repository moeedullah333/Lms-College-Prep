        ...
        <div class="row">
            <div class="col-md-10 mx-auto">
                <div class="student_form_main">
                    <form action="{{ route('admin.add.update.blog',$blog->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-row mb-3">
                            <div class="col">
                                ...
                                <textarea type="text" id="short_description" class="form-control"
                                    placeholder="Enter short Description" name="short_description" required>{{$blog->short_description}}</textarea>
                            </div>
                        </div>
                        <div class="form-row mb-3">
                            <div class="col">
                                <label for="firstname">Description</label>
                                <textarea class="summernote" id="summernote" name="description" rows="4" required>{{$blog->description}}</textarea>

                            </div>
                        </div>
                        <div class="form-group">
                            <label for="file">Upload Image</label>
                            <input type="file" class="form-control" id="file" onchange="previewImage(this)"
                                aria-describedby="emailHelp" placeholder="Please Upload Image" name="image">
                        </div>
                        <div class="form-group">
                            <img id="imagePreview" src="{{asset($blog->image)}}" height="200" width="200" class="preview"  />
                        </div>
